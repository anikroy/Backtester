...
public class Backtester extends optionsData{
    ...
    public static JPanel chart = null,
                         logs = null;
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        Testing.optionsData.runBackTest("AAPLD0513430.00", "O");
        Testing.optionsData.runBackTest("APL", "E");
        System.out.println("The runBackTest is finished");
        charts = new Draw();
        chart = (JPanel) charts.Price_Chart("AAPLD0513430.00");
